...
And an action game, first emulated and then ported:
...
- [`prince-of-persia-native/`](prince-of-persia-native/) — the same game
  re-implemented in JavaScript (`pop.html`) from Jordan Mechner's published
